...
export const PreOrderResponse = {
  ...
  _writeMessage: function (
    ...
    if (msg.paymentUrl) {
      writer.writeString(3, msg.paymentUrl);
    }
    return writer;
  },
  ...
  _readMessage: function (
    ...
    while (reader.nextField()) {
      ...
      switch (field) {
        ...
        case 3: {
          msg.paymentUrl = reader.readString();
          break;
        }
        default: {
          reader.skipField();
...
export const PreOrderResponseJSON = {
  ...
  _writeMessage: function (
    ...
    if (msg.paymentUrl) {
      json.paymentUrl = msg.paymentUrl;
    }
    return json;
  },
  ...
  _readMessage: function (msg: PreOrderResponse, json: any): PreOrderResponse {
    ...
    const _paymentUrl = json.paymentUrl ?? json.payment_url;
    if (_paymentUrl) {
      msg.paymentUrl = _paymentUrl;
    }
    return msg;
  },
};
