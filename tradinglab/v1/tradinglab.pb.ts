...
export const Order = {
  ...
  _writeMessage: function (
    ...
    if (msg.expiredAt) {
      writer.writeString(3, msg.expiredAt);
    }
    if (msg.cancelledAt) {
      writer.writeString(4, msg.cancelledAt);
    }
    if (msg.userId) {
  ...
  _readMessage: function (msg: Order, reader: BinaryReader): Order {
    while (reader.nextField()) {
      ...
      switch (field) {
        ...
        case 4: {
          msg.cancelledAt = reader.readString();
          break;
        }
        case 5: {
...
export const OrderJSON = {
  ...
  _writeMessage: function (msg: Partial<Order>): Record<string, unknown> {
    ...
    if (msg.cancelledAt) {
      json.cancelledAt = msg.cancelledAt;
    }
    if (msg.userId) {
