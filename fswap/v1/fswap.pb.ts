...
export async function ReadAssetJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ReadAsset",
    UniswapReq.ReadAssetJSON.encode(readAsset),
    config
  );
...
export async function ListAssetsJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ListAssets",
    UniswapReq.ListAssetsJSON.encode(listAssets),
    config
  );
  return UniswapResp.ListAssetsJSON.decode(response);
}
...
export async function ReadPairJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ReadPair",
    UniswapReq.ReadPairJSON.encode(readPair),
    config
  );
...
export async function ListPairsJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ListPairs",
    UniswapReq.ListPairsJSON.encode(listPairs),
    config
  );
  return UniswapResp.ListPairsJSON.decode(response);
}
...
export async function ReadDepositJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ReadDeposit",
    UniswapReq.ReadDepositJSON.encode(readDeposit),
    config
  );
...
export async function ReadTransactionJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ReadTransaction",
    UniswapReq.ReadTransactionJSON.encode(readTransaction),
    config
  );
...
export async function ListTransactionsJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ListTransactions",
    UniswapReq.ListTransactionsJSON.encode(listTransactions),
    config
  );
  return UniswapResp.ListTransactionsJSON.decode(response);
}
...
export async function ReadOrderJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ReadOrder",
    UniswapReq.ReadOrderJSON.encode(readOrder),
    config
  );
...
export async function PreOrderJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/PreOrder",
    UniswapReq.PreOrderJSON.encode(preOrder),
    config
  );
  return OrderJSON.decode(response);
}
...
export async function UpdateRoomJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/UpdateRoom",
    UniswapReq.UpdateRoomJSON.encode(updateRoom),
    config
  );
...
export async function FindRoomJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/FindRoom",
    UniswapReq.FindRoomJSON.encode(findRoom),
    config
  );
  return RoomJSON.decode(response);
}
...
export async function FindProposalJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/FindProposal",
    UniswapReq.FindProposalJSON.encode(findProposal),
    config
  );
...
export async function ListProposalsJSON(
  ...
  const response = await JSONrequest(
    "/fox.fswap.service.Uniswap/ListProposals",
    UniswapReq.ListProposalsJSON.encode(listProposals),
    config
  );
  return UniswapResp.ListProposalsJSON.decode(response);
}
    ...
    methods: {
      ...
      ListAssets: {
        ...
        input: {
          ...
          json: UniswapReq.ListAssetsJSON,
        },
        output: {
          protobuf: UniswapResp.ListAssets,
          json: UniswapResp.ListAssetsJSON,
        },
      },
      ReadPair: {
        name: "ReadPair",
        handler: service.ReadPair,
        input: { protobuf: UniswapReq.ReadPair, json: UniswapReq.ReadPairJSON },
      ...
      ListPairs: {
        ...
        input: {
          ...
          json: UniswapReq.ListPairsJSON,
        },
        output: {
          protobuf: UniswapResp.ListPairs,
          json: UniswapResp.ListPairsJSON,
        },
      },
      ReadDeposit: {
        name: "ReadDeposit",
        ...
        input: {
          ...
          json: UniswapReq.ReadDepositJSON,
        },
      ...
      ReadTransaction: {
        ...
        input: {
          ...
          json: UniswapReq.ReadTransactionJSON,
        },
      ...
      ListTransactions: {
        ...
        input: {
          ...
          json: UniswapReq.ListTransactionsJSON,
        },
        output: {
          protobuf: UniswapResp.ListTransactions,
          json: UniswapResp.ListTransactionsJSON,
        },
      },
      ReadOrder: {
        name: "ReadOrder",
      ...
      PreOrder: {
        ...
        input: { protobuf: UniswapReq.PreOrder, json: UniswapReq.PreOrderJSON },
        output: { protobuf: Order, json: OrderJSON },
      },
      UpdateRoom: {
        name: "UpdateRoom",
        ...
        input: {
          ...
          json: UniswapReq.UpdateRoomJSON,
        },
      ...
      FindRoom: {
        ...
        input: { protobuf: UniswapReq.FindRoom, json: UniswapReq.FindRoomJSON },
        output: { protobuf: Room, json: RoomJSON },
      },
      FindProposal: {
        name: "FindProposal",
        ...
        input: {
          ...
          json: UniswapReq.FindProposalJSON,
        },
      ...
      ListProposals: {
        ...
        input: {
          ...
          json: UniswapReq.ListProposalsJSON,
        },
        output: {
          protobuf: UniswapResp.ListProposals,
          json: UniswapResp.ListProposalsJSON,
        },
      },
    },
  } as const;
