...
export async function FindAssetJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/FindAsset",
    Req.FindAssetJSON.encode(findAsset),
    config
  );
...
export async function ListAssetsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListAssets",
    Req.ListAssetsJSON.encode(listAssets),
    config
  );
  return Resp.ListAssetsJSON.decode(response);
}
...
export async function FindOracleJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/FindOracle",
    Req.FindOracleJSON.encode(findOracle),
    config
  );
...
export async function ListOraclesJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListOracles",
    Req.ListOraclesJSON.encode(listOracles),
    config
  );
  return Resp.ListOraclesJSON.decode(response);
}
...
export async function ListCollateralsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListCollaterals",
    Req.ListCollateralsJSON.encode(listCollaterals),
    config
  );
  return Resp.ListCollateralsJSON.decode(response);
}
...
export async function FindCollateralJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/FindCollateral",
    Req.FindCollateralJSON.encode(findCollateral),
    config
  );
...
export async function FindVaultJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/FindVault",
    Req.FindVaultJSON.encode(findVault),
    config
  );
...
export async function ListVaultsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListVaults",
    Req.ListVaultsJSON.encode(listVaults),
    config
  );
  return Resp.ListVaultsJSON.decode(response);
}
...
export async function ListMyVaultsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListMyVaults",
    Req.ListMyVaultsJSON.encode(listMyVaults),
    config
  );
  return Resp.ListMyVaultsJSON.decode(response);
}
...
export async function ListVaultEventsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListVaultEvents",
    Req.ListVaultEventsJSON.encode(listVaultEvents),
    config
  );
  return Resp.ListVaultEventsJSON.decode(response);
}
...
export async function FindFlipJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/FindFlip",
    Req.FindFlipJSON.encode(findFlip),
    config
  );
...
export async function ListFlipsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListFlips",
    Req.ListFlipsJSON.encode(listFlips),
    config
  );
  return Resp.ListFlipsJSON.decode(response);
}
...
export async function ListFlipEventsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListFlipEvents",
    Req.ListFlipEventsJSON.encode(listFlipEvents),
    config
  );
  return Resp.ListFlipEventsJSON.decode(response);
}
...
export async function QueryFlipsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/QueryFlips",
    Req.QueryFlipsJSON.encode(queryFlips),
    config
  );
  return Resp.QueryFlipsJSON.decode(response);
}
...
export async function FindTransactionJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/FindTransaction",
    Req.FindTransactionJSON.encode(findTransaction),
    config
  );
...
export async function ListTransactionsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListTransactions",
    Req.ListTransactionsJSON.encode(listTransactions),
    config
  );
  return Resp.ListTransactionsJSON.decode(response);
}
...
export async function FindProposalJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/FindProposal",
    Req.FindProposalJSON.encode(findProposal),
    config
  );
...
export async function ListProposalsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListProposals",
    Req.ListProposalsJSON.encode(listProposals),
    config
  );
  return Resp.ListProposalsJSON.decode(response);
}
...
export async function ListStatsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListStats",
    Req.ListStatsJSON.encode(listStats),
    config
  );
  return Resp.ListStatsJSON.decode(response);
}
...
export async function ListAggregatedStatsJSON(
  ...
  const response = await JSONrequest(
    "/fox.pando.service.Pando/ListAggregatedStats",
    Req.ListAggregatedStatsJSON.encode(listAggregatedStats),
    config
  );
  ...
  return {
    ...
    methods: {
      FindAsset: {
        ...
        input: { protobuf: Req.FindAsset, json: Req.FindAssetJSON },
        output: { protobuf: Asset, json: AssetJSON },
      },
      ListAssets: {
        name: "ListAssets",
        handler: service.ListAssets,
        input: { protobuf: Req.ListAssets, json: Req.ListAssetsJSON },
        output: { protobuf: Resp.ListAssets, json: Resp.ListAssetsJSON },
      },
      FindOracle: {
        name: "FindOracle",
        handler: service.FindOracle,
        input: { protobuf: Req.FindOracle, json: Req.FindOracleJSON },
        output: { protobuf: Oracle, json: OracleJSON },
      },
      ListOracles: {
        name: "ListOracles",
        handler: service.ListOracles,
        input: { protobuf: Req.ListOracles, json: Req.ListOraclesJSON },
        output: { protobuf: Resp.ListOracles, json: Resp.ListOraclesJSON },
      },
      ListCollaterals: {
        name: "ListCollaterals",
        handler: service.ListCollaterals,
        input: { protobuf: Req.ListCollaterals, json: Req.ListCollateralsJSON },
        output: {
          protobuf: Resp.ListCollaterals,
          json: Resp.ListCollateralsJSON,
        },
      },
      FindCollateral: {
        name: "FindCollateral",
        handler: service.FindCollateral,
        input: { protobuf: Req.FindCollateral, json: Req.FindCollateralJSON },
        output: { protobuf: Collateral, json: CollateralJSON },
      },
      FindVault: {
        name: "FindVault",
        handler: service.FindVault,
        input: { protobuf: Req.FindVault, json: Req.FindVaultJSON },
        output: { protobuf: Vault, json: VaultJSON },
      },
      ListVaults: {
        name: "ListVaults",
        handler: service.ListVaults,
        input: { protobuf: Req.ListVaults, json: Req.ListVaultsJSON },
        output: { protobuf: Resp.ListVaults, json: Resp.ListVaultsJSON },
      },
      ListMyVaults: {
        name: "ListMyVaults",
        handler: service.ListMyVaults,
        input: { protobuf: Req.ListMyVaults, json: Req.ListMyVaultsJSON },
        output: { protobuf: Resp.ListMyVaults, json: Resp.ListMyVaultsJSON },
      },
      ListVaultEvents: {
        name: "ListVaultEvents",
        handler: service.ListVaultEvents,
        input: { protobuf: Req.ListVaultEvents, json: Req.ListVaultEventsJSON },
        output: {
          protobuf: Resp.ListVaultEvents,
          json: Resp.ListVaultEventsJSON,
        },
      },
      FindFlip: {
        name: "FindFlip",
        handler: service.FindFlip,
        input: { protobuf: Req.FindFlip, json: Req.FindFlipJSON },
        output: { protobuf: Flip, json: FlipJSON },
      },
      ListFlips: {
        name: "ListFlips",
        handler: service.ListFlips,
        input: { protobuf: Req.ListFlips, json: Req.ListFlipsJSON },
        output: { protobuf: Resp.ListFlips, json: Resp.ListFlipsJSON },
      },
      ListFlipEvents: {
        name: "ListFlipEvents",
        handler: service.ListFlipEvents,
        input: { protobuf: Req.ListFlipEvents, json: Req.ListFlipEventsJSON },
        output: {
          protobuf: Resp.ListFlipEvents,
          json: Resp.ListFlipEventsJSON,
        },
      },
      QueryFlips: {
        name: "QueryFlips",
        handler: service.QueryFlips,
        input: { protobuf: Req.QueryFlips, json: Req.QueryFlipsJSON },
        output: { protobuf: Resp.QueryFlips, json: Resp.QueryFlipsJSON },
      },
      FindTransaction: {
        name: "FindTransaction",
        handler: service.FindTransaction,
        input: { protobuf: Req.FindTransaction, json: Req.FindTransactionJSON },
      ...
      ListTransactions: {
        ...
        input: {
          ...
          json: Req.ListTransactionsJSON,
        },
        output: {
          protobuf: Resp.ListTransactions,
          json: Resp.ListTransactionsJSON,
        },
      },
      FindProposal: {
        name: "FindProposal",
        handler: service.FindProposal,
        input: { protobuf: Req.FindProposal, json: Req.FindProposalJSON },
        output: { protobuf: Proposal, json: ProposalJSON },
      },
      ListProposals: {
        name: "ListProposals",
        handler: service.ListProposals,
        input: { protobuf: Req.ListProposals, json: Req.ListProposalsJSON },
        output: { protobuf: Resp.ListProposals, json: Resp.ListProposalsJSON },
      },
      ListStats: {
        name: "ListStats",
        handler: service.ListStats,
        input: { protobuf: Req.ListStats, json: Req.ListStatsJSON },
        output: { protobuf: Resp.ListStats, json: Resp.ListStatsJSON },
      },
      ListAggregatedStats: {
        ...
        input: {
          ...
          json: Req.ListAggregatedStatsJSON,
        },
        output: {
